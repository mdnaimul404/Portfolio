    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td data-label="Description"><?= htmlspecialchars(substr($row['description'], 0, 100)) ?>...</td>
                <td data-label="Project Link"><a href="<?= htmlspecialchars($row['project_link']) ?>" target="_blank" rel="noopener noreferrer">View</a></td>
                <td data-label="Actions">
                    <a href="edit_project.php?id=<?= $row['id'] ?>">Edit</a>
                    <a href="manage-projects.php?delete=<?= $row['id'] ?>" onclick="return confirm('Are you sure?');">Delete</a>
                </td>
            </tr>
            <?php endwhile; ?>
        </tbody>
